...
class TestSeigrCellEncoder(unittest.TestCase):
    ...
    def test_encode_data(self):
        ...
        encoded_cell = self.encoder.encode(self.data, metadata=self.metadata, password=self.password)
    ...
    def test_decode_data(self):
        ...
        self.assertEqual(decoded_metadata, self.metadata, "Decoded metadata should match the original metadata")
    ...
    def test_integrity_verification(self):
        ...
        self.assertEqual(self.encoder.hash_tree["primary_hash"], computed_primary_hash,
    ...
    def test_integrity_failure_on_manipulation(self):
        ...
        with self.assertRaises(ValueError, msg="Integrity verification should fail for tampered data"):
