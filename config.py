...
class Config:
    ...
    SEIGR_ID_DIRECTORY = os.path.join(SEIGR_DIRECTORY, "test_ids")  # Add a directory for identity testing
    ...
    os.makedirs(SEIGR_ID_DIRECTORY, exist_ok=True)  # Ensure test identity directory exists
