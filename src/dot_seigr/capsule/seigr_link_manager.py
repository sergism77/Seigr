...
class FileLinkManager:
    ...
    def set_links(self, primary: str, secondary: list):
        ...
        if not isinstance(secondary, list) or not all(isinstance(link, str) and link for link in secondary):
            secure_logger.log_audit_event("error", "LinkManager", "Invalid secondary links provided.")
    ...
    def add_secondary_link(self, link: str):
        ...
        if not isinstance(link, str) or not link:
            secure_logger.log_audit_event("error", "LinkManager", "Invalid secondary link provided.")
    ...
    def clear_links(self):
        ...
        """
        self.links = {"primary": None, "secondary": []}
        secure_logger.log_audit_event("info", "LinkManager", "Cleared all primary and secondary links.")
